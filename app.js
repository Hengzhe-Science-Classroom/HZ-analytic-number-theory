// === Analytic Number Theory - Core Application ===
...
const App = {
    ...
    // --- Progress ---
    loadProgress() {
        try { this.progress = JSON.parse(localStorage.getItem('analytic-number-theory-progress') || '{}'); }
        catch (e) { this.progress = {}; }
    },
    saveProgress() {
        try { localStorage.setItem('analytic-number-theory-progress', JSON.stringify(this.progress)); } catch (e) {}
    },
